...
<@layout.mainLayout active='authorization' bodyClass='authorization'; section>
    ...
    <@layout.contentHeader required=true; section>
        ...
        <div class="col-md-12">
                <table class="table">
                    ...
                    <tbody>
                                ...
                                <form action="${url.getResourceGrant(authorization.resource.id)}" name="revokeForm-${authorization.resource.id}-${permission.requester.username}" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%" align="middle" style="vertical-align: middle">
                                            <a href="#" id="revoke-${authorization.resource.name}-${permission.requester.username}" onclick="removeAllScopes('${authorization.resource.id}-${permission.requester.username}');document.forms['revokeForm-${authorization.resource.id}-${permission.requester.username}'].submit();" type="submit" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!}">${msg("doRevoke")}</a>
                                        </td>
                                    </tr>
                                </form>
                            </#list>
                        <#else>
                            <tr>
                                <td class="empty" colspan="4">${msg("resourceIsNotBeingShared")}</td>
                            </tr>
                        </#if>
                    </tbody>
                </table>
            ...
            <form action="${url.getResourceShare(authorization.resource.id)}" name="shareForm" method="post">
                ...
                <div class="col-sm-8 col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <br/>
                            <a href="#" onclick="document.forms['shareForm'].submit()" type="submit" id="share-button" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!}">${msg("share")}</a>
                        </div>
                    </div>
                </div>
            </form>
