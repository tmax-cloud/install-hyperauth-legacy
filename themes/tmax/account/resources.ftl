                                ...
                                <form action="${url.getResourceGrant(resource.id)}" name="approveForm-${resource.id}-${permission.requester.username}" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%" align="middle" style="vertical-align: middle">
                                            <a href="#" id="grant-${resource.name}-${permission.requester.username}" onclick="document.forms['approveForm-${resource.id}-${permission.requester.username}']['action'].value = 'grant';document.forms['approveForm-${resource.id}-${permission.requester.username}'].submit();" type="submit" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!}">${msg("doApprove")}</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table">
                ...
                <#else>
                    <tr>
                        <td class="empty" colspan="4">${msg("notHaveAnyResource")}</td>
                    </tr>
                </#if>
                </tbody>
            </table>
            ...
            <form action="${url.resourceUrl}" name="shareForm" method="post">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <#else>
                            <tr>
                                <td class="empty" colspan="6">${msg("noResourcesSharedWithYou")}</td>
                            </tr>
                        </#if>
                    </tbody>
                </table>
