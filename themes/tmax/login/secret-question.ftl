            ...
            <form id="secret-question-form" action="${url.loginAction}" method="post">
                <div class="${properties.kcFormGroupClass!} marginTop">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="secret_answer" class="${properties.kcLabelClass!}">What is your mom's first name</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!} marginBottom">
                        <input type="text" id="secret_answer" name="secret_answer" class="${properties.kcInputClass!}<#if message?has_content> has-${message.type}</#if>" autofocus onkeyup="removeError(this)"/>
                        <div>
