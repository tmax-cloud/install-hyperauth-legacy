...
<!--<![endif]-->
  ...
  <body>
    <div class="container">
      ...
      <div class="bs-example" style="margin-top: 40px;" id="popover-right-title-close">
      ...
      <div class="bs-example" style="margin-top: 40px;" id="popover-right-close">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-right-title">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-right">
      ...
      <hr>
      <div class="bs-example" style="margin-top: 40px;" id="popover-left-title-close">
      ...
      <div class="bs-example" style="margin-top: 40px;" id="popover-left-close">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-left-title">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-left">
      ...
      <hr>
      <div class="bs-example" style="margin-top: 40px;" id="popover-top-title-close">
      ...
      <div class="bs-example" style="margin-top: 40px;" id="popover-top-close">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-top-title">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-top">
      ...
      <hr>
      <div class="bs-example" style="margin-top: 40px;" id="popover-bottom-title-close">
      ...
      <div class="bs-example" style="margin-top: 40px;" id="popover-bottom-close">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-bottom-title">
      ...
      <div class="bs-example" style="margin: 40px 0;" id="popover-bottom">
  ...
  <div class="form-group">
    <label class="col-sm-3 control-label" for="fieldlevelhelp">Default <a tabindex="0" role="button" data-toggle="popover" data-trigger="focus" data-html="true" class="popover-pf-info" title="popover-pf-info" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et <a href='#'>dolore magna aliqua</a>." data-placement="top"><span class="pficon pficon-info"></span></a></label>
    <div class="col-sm-9">
