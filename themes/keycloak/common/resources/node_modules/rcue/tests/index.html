      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <ul>
            ...
            <li>
              <a href="inline-edit-for-form.html">Inline edit in a form</a>
            </li>
            <li>
        ...
        <div class="col-sm-6">
          ...
          <ul>
            ...
            <li>
              <a href="bullet-charts.html">Bullet Charts</a>
            </li>
            <li>
        ...
        <div class="col-sm-6">
          ...
          <ul>
            ...
            <li>
              <a href="tree-list-view-multiple-child-expansion.html">Tree List View - Multiple Child Expansion</a>
            </li>
            <li>
              <a href="tree-list-view-single-child-expansion.html">Tree List View - Single Child Expansion</a>
            </li>
            <li>
