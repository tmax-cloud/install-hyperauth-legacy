      ...
      <div class="row">
        <div class="col-sm-6 col-md-6">
          ...
          <ul class="icons list-unstyled">
            ...
            <li>
              <span class="pficon pficon-sort-common-asc"></span>
              <span class="icon-class">pficon-sort-common-asc</span>
            </li>
            <li>
              <span class="pficon pficon-sort-common-desc"></span>
              <span class="icon-class">pficon-sort-common-desc</span>
            </li>
